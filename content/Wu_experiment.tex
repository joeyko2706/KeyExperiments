...
The intrinsic parity of a particle is calculated via the orbital angular momentum or spin $l$ by %\inlineequation[eq:intrinsicParity]{\hat P=(-1)^l}. %$\hat P=(-1)^l$.
\begin{align}
    \hat P=(-1)^l.
...
The experiment was based on the beta-decay of Cobalt via $\cobalt\rightarrow \nickel+e^-+2\gamma+\bar\nu_e$.
% \begin{align}
%     \label{eq:CobaltDecay}
%     \cobalt\rightarrow \nickel+e^-+2\gamma+\bar\nu_e.
% \end{align}
